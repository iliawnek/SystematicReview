...
$('#abstract').pageMe({pagerSelector:'#abstract-pager'});
$('#document').pageMe({pagerSelector:'#document-pager'});
$('#final').pageMe({pagerSelector:'#final-pager'});
$('#rejected').pageMe({pagerSelector:'#rejected-pager'});
